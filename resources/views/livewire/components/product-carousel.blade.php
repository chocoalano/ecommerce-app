<div class="bg-white py-10">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8"> {{-- max-w-5/6 diganti 7xl untuk standar Tailwind --}}
        <div x-data="{
            scrollBy(delta) {
                const el = $refs.track;
            ...
            <div class="relative">
                ...
                <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between mb-8 sm:mb-10">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="hidden sm:flex space-x-3"> {{-- Sembunyikan navigasi tombol di mobile jika carousel bisa di-scroll --}}
                            {{-- Tombol Sebelumnya --}}
                ...
                <div x-ref="track"
                    ...
                    @foreach ($data as $i => $p)
                        ...
                        @php
                            ...
                            $price = $p['price'] ?? 'Rp 0';
                            $image = $p['image'] ?? 'path/to/default/image.jpg';
                        @endphp

                        <article
                            class="group snap-start shrink-0 
                            ...
                            <div class="px-4 pt-2 pb-5">
                                ...
                                <h3 class="text-base font-semibold text-gray-800 leading-snug h-10 overflow-hidden mb-1" title="{{ $title_card }}">
